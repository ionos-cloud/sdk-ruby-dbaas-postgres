...
module IonoscloudDbaasPostgres
  class ApiClient
    ...
    def initialize(config = Configuration.default)
      @config = config
      @user_agent = "sdk-ruby-dbaas-postgres/v1.1.0"
      @default_headers = {
    ...
    def convert_to_type(data, return_type)
      ...
      when /\AHash\<String, (.+)\>\z/
        ...
        klass = IonoscloudDbaasPostgres.const_get(return_type)
    ...
    def wait_for(timeout = 3600, initial_wait = 5, scaleup = 10, &_block)
      ...
      while true
        ...
        if timeout && current_time > timeout
          raise IonoscloudDbaasPostgres::ApiError.new(message: "Timed out.")
        end
